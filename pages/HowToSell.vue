<template>
  <div class="text-wrap">
    <div class="container">
      ...
      <p class="text">
        Inden du kommer ned i butikken
      </p>
      <table>
        <tr>
          <td />
      ...
      <ul class="list-disc">
        ...
        <li class="text">
          Det er gratis - vi sender en pakkelabel til dig på mail.
        </li>
        <li class="text">
          Få hurtig betaling. Vi undersøger din enhed og sender pengene 2 dage efter modtagelse
        </li>
        <li class="text">
      ...
      <h3 class="font-bold subtitle text-center">
        I butikken
      </h3>
      <p class="text">
        Personalet vurderer produktet og giver dig en pris
      </p>
      <ul class="list-disc">
        <li class="text">
      ...
      <p class="text italic">
        Er I en virksomhed med mere end 10 enheder i vil sælge? <a href="#" class="underline y-link">Læs mere her.</a>
      </p>
      <ul class="list-disc">
        <li class="text">
