<template>
  ...
  <div class="text-wrap">
    ...
    <div class="container">
      <h1 class="font-bold title mb">Klargør din Android enhed til indlevering</h1>
      <h3 class="font-bold subtitle mb">
          Guide til klargøring af Android telefoner og tablets før indlevering til reparation eller salg.
      </h3>
      ...
      <p class="text mb">
        <ul class="list-disc">
          <li class="text mb">
            Log ind på <a href="https://myaccount.google.com">myaccount.google.com</a>
          </li>
          <li class="text mb">
            Vælg ”Login og sikkerhed”
          </li>
          <li class="text mb">
            Klik på ”Enhedsaktivitet og underretninger”
          </li>
          <li class="text mb">
            Klik på ”Se enheder” i listen over senest benyttede enheder
          </li>
          <li class="text mb">
            Klik på den enhed, der skal fjernes og klik på ”Fjern”
          </li>
        </ul>
      </p>
      ...
      <h3 class="font-bold subtitle mb">Trin 4, slet data på SD-kortet</h3>
      <p class="text mb">
          Husk at rense SD-kortet. Dette gør du under ”Indstillinger for lager”. Du kan selvfølgelig også vælge at købe et nyt, og beholde dit gamle SD-kort, eller brække det i stykker hvis ikke du ønsker at bruge det længere.
      </p>
      <h3 class="font-bold subtitle mb">Trin 5, slet og nulstil telefonen</h3>
      <p class="text mb">
          Nu er vi nået til punktet, hvor du nulstiller din telefon. Et træk du først laver, når du er helt sikker på at din data er sikkerhedskopieret. Gå til ”Indstillinger” -> Tryk på ”Nulstil og sikkerhedskopier” -> Tryk på ”Nulstil telefon”. Nu sletter din telefon alt indhold fra lageret.
      </p>
