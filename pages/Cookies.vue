<template>
  <div class="text-wrap">
    <div class="container">
      ...
      <p class="text mb">
        GreenMind.dk bruger cookies til at gemme oplysninger om brugerfunktioner såsom sorteringsmuligheder, hvor mange produkter, der vises og muligheden for at være logget ind på hjemmesiden som medlem. Vi bruger også cookies til at indsamle informationer om hvilke sider du besøger på hjemmesiden, så vi kan vise de annoncer, der er mest relevante for dig. Cookies bruges også til at analysere trafikken på hjemmesiden.
