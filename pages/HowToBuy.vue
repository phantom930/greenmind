<template>
  ...
  <div class="text-wrap">
    <div class="container">
      <h1 class="font-bold title">Sådan køber du</h1>
      <p class="text">
      ...
      <p class="text italic">Nemt og smart</p>
      <p class="text">
      ...
      <ul class="list-disc">
        <li class="text">Alle brugte produkter bliver renset, nulstillet og klargjort for at sikre, at du får en vare, der er uden fejl og mangler.</li>
        <li class="text">Du får 2 års garanti på brugt elektronik købt hos GreenMind, gældende fra købstidspunktet.</li>
        <li class="text">
      ...
      <p class="text italic">Find GreenMind</p>
      <p class="text">Klik <a href="#" class="underline y-link">her</a> og se, hvor du kan købe brugt elektronik.</p>
    </div>
  </div>
