<template>
  ...
  >
    ...
    >
      <SfList>
        <SfListItem
          v-for="(item, indexChild) in productColumn.childs"
          :key="indexChild"
        >
          <SfMenuItem
            :label="$t(item.name)"
    ...
    <SfFooterColumn class="desktop-only">
      <div class="sf-footer-column__title desktop-only sf-heading">
        {{ $t('Shops') }}
      </div>
      <SfList>
        <SfListItem
      ...
      <div class="sf-footer-column__title desktop-only sf-heading mt-5">
        {{ $t('Contact') }}
      </div>
      <SfList>
        <SfListItem
